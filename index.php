  ...
  <section class="home-body">
    <div>
      <table class="table-home">
        ...
        <tr>
          <th width="800">
            <h2>Welcome to My<br>Youtube Downloader Web App</h2>
          </th>
        </tr>
        ...
        <tr align="center">
          <td>
            <h3><br>Why Choose My Website</h3>
          </td>
        </tr>
        ...
        <tr>
          <td align="justify">
            ...
            <video width="100%" controls>
              <source src="video/Web App.webm" type="video/mp4">
            </video>
          </td>
        </tr>
        ...
        <tr align="center">
          <td>
            <h3><br>Copyright Warning</h3>
          </td>
        </tr>
        <tr align="justify">
          <td>While we're committed to providing a seamless downloading experience, it's crucial to acknowledge and respect the rights of content creators. We urge all our users to use [Your Website Name] in a responsible and legal manner. Downloading copyrighted material without proper authorization may infringe on intellectual property rights and could lead to legal consequences.</td>
        </tr>
